...
{
    Task<List<Form>> ListBySpaceOrderedAsync(string spaceId, CancellationToken cancellationToken = default);

    Task<List<Form>> ListAllAsync(CancellationToken cancellationToken = default);

    Task<Form?> GetByIdAsync(string id, CancellationToken cancellationToken = default);
