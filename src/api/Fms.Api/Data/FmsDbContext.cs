...
/// <summary>EF Core context over the FMS PostgreSQL schema (feature 02).</summary>
public class FmsDbContext(DbContextOptions<FmsDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Form>(e =>
        {
            ...
            e.Property(f => f.UpdatedAt).HasColumnType("timestamptz").HasDefaultValueSql("now()");
        });
        ...
        modelBuilder.Entity<Submission>(e =>
        {
            ...
            e.Property(s => s.CreatedAt).HasColumnType("timestamptz").HasDefaultValueSql("now()");
        });
