...
/// object id is the unique external identity. Persistence goes through
/// <see cref="IUserRepository"/> (the EF Core layer), never directly.
/// </summary>
public sealed class UserProvisioner(IUserRepository users, IConfiguration configuration) : IUserProvisioner
{
