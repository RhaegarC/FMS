...
/// <summary>
/// A <c>FmsDbContext</c> with the audit interceptor attached, wired the way the application
...
public sealed class AuditHarness : IDisposable
{
    ...
    public AuditHarness(FakeUserContext? user = null)
    {
        ...
        Context = _scope.ServiceProvider.GetRequiredService<FmsDbContext>();
    }
