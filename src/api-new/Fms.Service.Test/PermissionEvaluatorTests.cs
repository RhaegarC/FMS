...
/// <summary>
/// RED for feature 03 (permission evaluation): effective-access computation over
/// <c>permissions</c> rows. Space grants cover the whole subtree of forms; form access is
/// the union of form-level and space-level grants; resourceId "*" matches every resource
/// of the type; default deny when no matching row's expression is true. Resource ids are
